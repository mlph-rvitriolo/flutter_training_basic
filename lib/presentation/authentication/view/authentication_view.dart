...
import 'package:flutter_training_basic/screens/grocery_list/view/grocery_list_view.dart';
                ...
                Column(
                  ...
                  children: <Widget>[
                    Align(
                      ...
                      child: Text(mode == AuthMode.login ? 'Login' : 'Register',
                          style: Theme.of(context).textTheme.headlineMedium),
                    ),
                    const SizedBox(height: 21),
                    Visibility(
                      visible: viewModel.errorMessage != '',
                      child: buildErrorMessage(context, viewModel.errorMessage,
